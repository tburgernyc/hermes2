...
/**
 * §3.2 baseline audit: Next.js App Router error boundary for the public tokenized /quote/[token] page.
  ...
  return (
    <PublicShell>
      <Card>
        ...
        <p>An unexpected error occurred. Your quote was not submitted.</p>
