 ...
 *  13. manual/0012_ai_field_grants.sql column-level SELECT so the low-trust roles can't read operator AI fields
 *
...
async function main(): Promise<void> {
  ...
  try {
    ...
    await runManual(pool, "0012_ai_field_grants.sql");
